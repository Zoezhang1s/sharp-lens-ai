...
## 🔥 一句话暴击
（**必须毒舌、犀利、戳心、有网感**——像顶级毒舌摄影博主开喷，一句话把这张照片最致命的硬伤钉死。要有画面感、有梗、有锋利度，可用比喻/反讽/暴击型短句，让人看完又想笑又脸红。**严禁**温吞话术，例如"照片不错但..."、"整体还行只是..."、"建议下次..."一律禁止。烂片直接判死刑，例如"烂片一张，废片看了都想退群"、"这构图，相机自己都想跳楼"、"光线把你拍成了一张烙饼"。即使是好片，也要用一句犀利金句精准戳中最大短板，不许只夸不刺。一句话不超过35个汉字，要狠、要准、要让人记住）
