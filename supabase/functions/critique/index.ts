...
## 🎨 风格识别
**当前风格**: 必须从以下风格名称中选择最接近的一个：日系小清新、韩系ins风、新中式、私房写真、自然户外风、情绪胶片风、大女主风、赛博朋克风、经典肖像、酷炫暗黑风、复古胶片风、城市街拍风、极简留白风、高奢时尚风
**推荐方向**: 从上述风格中推荐1-2个更适合的，一句话说清为什么

## 📱 学习参考
根据这张照片的摄影主题，给出小红书和抖音的搜索关键词，帮助用户找到高赞参考作品：
- 🔍 小红书搜索: [具体搜索关键词](https://www.xiaohongshu.com/search_result?keyword=搜索关键词)
- 🔍 抖音搜索: [具体搜索关键词](https://www.douyin.com/search/搜索关键词)
